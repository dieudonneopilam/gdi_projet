...
<div class="annuaire">
    <div class="div-content">
        <div class="entete">
           ...
           <a class="add" href="{{ route('user.create') }}">
        ...
        <div class="block-annuaire">
            <div class="left-an">
                <img class="img-annuaire" src="{{ Storage::url($user->file) }}" alt="">
                @isset(auth()->user()->id)
                <div class="actions">
                    @if(auth()->user()->id == $user->id || auth()->user()->isadmin == 1)
                    <a class="edit" href="{{ route('user.edit',['user'=>$user->id]) }}">
                    ...
                    @if(auth()->user()->isadmin == 1)
                        ...
                        <form action="{{ route('user.destroy',$user->id) }}" method="POST">
                            @method('DELETE')
                            {{ csrf_field() }}
                            <button style="border: 1px solid transparent" type="submit" class="delete">
